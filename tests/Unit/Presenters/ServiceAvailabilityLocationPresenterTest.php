...
class ServiceAvailabilityLocationPresenterTest extends TestCase
{
    protected $presenter;
    ...
    {
        parent::setUp();
        $this->presenter = new ServiceAvailabilityLocationPresenter();
    }

    public function test_presenter_can_be_instantiated(): void
    {
        $this->assertInstanceOf(ServiceAvailabilityLocationPresenter::class, $this->presenter);
    ...
    public function test_get_transformer_returns_correct_transformer(): void
    {
        ...
        $this->assertInstanceOf(ServiceAvailabilityLocationTransformer::class, $transformer);
    }
