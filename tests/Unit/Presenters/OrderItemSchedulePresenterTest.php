...
use Tests\TestCase;
use App\Presenters\OrderItemSchedulePresenter;
use App\Transformers\OrderItemScheduleTransformer;
use League\Fractal\TransformerAbstract;
use Prettus\Repository\Presenter\FractalPresenter;

class OrderItemSchedulePresenterTest extends TestCase
{
    protected $presenter;
    ...
    {
        parent::setUp();
        $this->presenter = new OrderItemSchedulePresenter();
    }

    public function test_presenter_can_be_instantiated(): void
    {
        $this->assertInstanceOf(OrderItemSchedulePresenter::class, $this->presenter);
    ...
    public function test_get_transformer_returns_correct_transformer(): void
    {
        ...
        $this->assertInstanceOf(OrderItemScheduleTransformer::class, $transformer);
    }
