...
class OrderItemPresenterTest extends TestCase
{
    protected $presenter;
    ...
    {
        parent::setUp();
        $this->presenter = new OrderItemPresenter();
    }

    public function test_presenter_can_be_instantiated(): void
    {
        $this->assertInstanceOf(OrderItemPresenter::class, $this->presenter);
    ...
    public function test_get_transformer_returns_correct_transformer(): void
    {
        ...
        $this->assertInstanceOf(OrderItemTransformer::class, $transformer);
    }
