...
class PricingPresenterTest extends TestCase
{
    protected $presenter;
    ...
    {
        parent::setUp();
        $this->presenter = new PricingPresenter();
    }

    public function test_presenter_can_be_instantiated(): void
    {
        $this->assertInstanceOf(PricingPresenter::class, $this->presenter);
    ...
    public function test_get_transformer_returns_correct_transformer(): void
    {
        ...
        $this->assertInstanceOf(PricingTransformer::class, $transformer);
    }
