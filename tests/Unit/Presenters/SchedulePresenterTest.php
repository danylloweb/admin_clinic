...
class SchedulePresenterTest extends TestCase
{
    protected $presenter;
    ...
    {
        $this->assertInstanceOf(SchedulePresenter::class, $this->presenter);
    ...
    public function test_get_transformer_returns_correct_transformer(): void
    {
        ...
        $this->assertInstanceOf(ScheduleTransformer::class, $transformer);
    }
