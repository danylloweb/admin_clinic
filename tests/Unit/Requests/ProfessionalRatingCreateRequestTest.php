...
use Tests\TestCase;
use App\Http\Requests\ProfessionalRatingCreateRequest;
use Illuminate\Validation\Rule;

class ProfessionalRatingCreateRequestTest extends TestCase
{
    protected $request;
    ...
    {
        parent::setUp();
        $this->request = new ProfessionalRatingCreateRequest;
    }

    public function test_request_can_be_instantiated(): void
    {
        $this->assertInstanceOf(ProfessionalRatingCreateRequest::class, $this->request);
    }
