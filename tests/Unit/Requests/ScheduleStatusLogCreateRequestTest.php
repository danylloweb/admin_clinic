...
use Tests\TestCase;
use App\Http\Requests\ScheduleStatusLogCreateRequest;
use Illuminate\Validation\Rule;

class ScheduleStatusLogCreateRequestTest extends TestCase
{
    protected $request;
    ...
    {
        parent::setUp();
        $this->request = new ScheduleStatusLogCreateRequest;
    }

    public function test_request_can_be_instantiated(): void
    {
        $this->assertInstanceOf(ScheduleStatusLogCreateRequest::class, $this->request);
    }
