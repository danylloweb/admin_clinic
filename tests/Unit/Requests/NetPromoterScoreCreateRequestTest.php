...
class NetPromoterScoreCreateRequestTest extends TestCase
{
    protected $request;
    ...
    {
        parent::setUp();
        $this->request = new NetPromoterScoreCreateRequest;
    }

    public function test_request_can_be_instantiated(): void
    {
        $this->assertInstanceOf(NetPromoterScoreCreateRequest::class, $this->request);
    }
