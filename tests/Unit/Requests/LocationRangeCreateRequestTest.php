...
use Tests\TestCase;
use App\Http\Requests\LocationRangeCreateRequest;
use Illuminate\Validation\Rule;

class LocationRangeCreateRequestTest extends TestCase
{
    protected $request;
    ...
    {
        parent::setUp();
        $this->request = new LocationRangeCreateRequest;
    }

    public function test_request_can_be_instantiated(): void
    {
        $this->assertInstanceOf(LocationRangeCreateRequest::class, $this->request);
    }
