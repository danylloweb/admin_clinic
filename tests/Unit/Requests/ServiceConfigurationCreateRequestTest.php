...
use Tests\TestCase;
use App\Http\Requests\ServiceConfigurationCreateRequest;
use Illuminate\Validation\Rule;

class ServiceConfigurationCreateRequestTest extends TestCase
{
    protected $request;
    ...
    {
        parent::setUp();
        $this->request = new ServiceConfigurationCreateRequest;
    }

    public function test_request_can_be_instantiated(): void
    {
        $this->assertInstanceOf(ServiceConfigurationCreateRequest::class, $this->request);
    }
