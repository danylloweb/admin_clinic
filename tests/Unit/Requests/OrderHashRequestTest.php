...
use Tests\TestCase;
use App\Http\Requests\OrderHashRequest;
use Illuminate\Validation\Rule;

class OrderHashRequestTest extends TestCase
{
    protected $request;
    ...
    {
        parent::setUp();
        $this->request = new OrderHashRequest;
    }

    public function test_request_can_be_instantiated(): void
    {
        $this->assertInstanceOf(OrderHashRequest::class, $this->request);
    }
