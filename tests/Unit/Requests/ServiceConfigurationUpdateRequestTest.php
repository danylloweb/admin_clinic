...
use Tests\TestCase;
use App\Http\Requests\ServiceConfigurationUpdateRequest;
use Illuminate\Validation\Rule;

class ServiceConfigurationUpdateRequestTest extends TestCase
{
    protected $request;
    ...
    {
        parent::setUp();
        $this->request = new ServiceConfigurationUpdateRequest;
    }

    public function test_request_can_be_instantiated(): void
    {
        $this->assertInstanceOf(ServiceConfigurationUpdateRequest::class, $this->request);
    }
