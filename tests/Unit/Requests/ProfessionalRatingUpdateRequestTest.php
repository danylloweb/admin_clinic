...
use Tests\TestCase;
use App\Http\Requests\ProfessionalRatingUpdateRequest;
use Illuminate\Validation\Rule;

class ProfessionalRatingUpdateRequestTest extends TestCase
{
    protected $request;
    ...
    {
        parent::setUp();
        $this->request = new ProfessionalRatingUpdateRequest;
    }

    public function test_request_can_be_instantiated(): void
    {
        $this->assertInstanceOf(ProfessionalRatingUpdateRequest::class, $this->request);
    }
