...
use Tests\TestCase;
use App\Http\Requests\ScheduleStatusLogUpdateRequest;
use Illuminate\Validation\Rule;

class ScheduleStatusLogUpdateRequestTest extends TestCase
{
    protected $request;
    ...
    {
        parent::setUp();
        $this->request = new ScheduleStatusLogUpdateRequest;
    }

    public function test_request_can_be_instantiated(): void
    {
        $this->assertInstanceOf(ScheduleStatusLogUpdateRequest::class, $this->request);
    }
