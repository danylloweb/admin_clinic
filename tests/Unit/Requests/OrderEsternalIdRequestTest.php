...
class OrderEsternalIdRequestTest extends TestCase
{
    protected $request;
    ...
    {
        parent::setUp();
        $this->request = new OrderEsternalIdRequest;
    }

    public function test_request_can_be_instantiated(): void
    {
        $this->assertInstanceOf(OrderEsternalIdRequest::class, $this->request);
    }
