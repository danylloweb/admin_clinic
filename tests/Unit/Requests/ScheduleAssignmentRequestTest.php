...
class ScheduleAssignmentRequestTest extends TestCase
{
    protected $request;
    ...
    {
        parent::setUp();
        $this->request = new ScheduleAssignmentRequest;
    }

    public function test_request_can_be_instantiated(): void
    {
        $this->assertInstanceOf(ScheduleAssignmentRequest::class, $this->request);
    }
