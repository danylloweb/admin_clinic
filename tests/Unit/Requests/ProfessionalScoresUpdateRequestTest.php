...
use Tests\TestCase;
use App\Http\Requests\ProfessionalScoresUpdateRequest;
use Illuminate\Validation\Rule;

class ProfessionalScoresUpdateRequestTest extends TestCase
{
    protected $request;
    ...
    {
        parent::setUp();
        $this->request = new ProfessionalScoresUpdateRequest;
    }

    public function test_request_can_be_instantiated(): void
    {
        $this->assertInstanceOf(ProfessionalScoresUpdateRequest::class, $this->request);
    }
