...
use Tests\TestCase;
use App\Http\Requests\NetPromoterScoreUpdateRequest;
use Illuminate\Validation\Rule;

class NetPromoterScoreUpdateRequestTest extends TestCase
{
    protected $request;
    ...
    {
        parent::setUp();
        $this->request = new NetPromoterScoreUpdateRequest;
    }

    public function test_request_can_be_instantiated(): void
    {
        $this->assertInstanceOf(NetPromoterScoreUpdateRequest::class, $this->request);
    }
