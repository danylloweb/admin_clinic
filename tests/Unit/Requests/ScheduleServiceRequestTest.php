...
class ScheduleServiceRequestTest extends TestCase
{
    protected $request;
    ...
    {
        parent::setUp();
        $this->request = new ScheduleServiceRequest;
    }

    public function test_request_can_be_instantiated(): void
    {
        $this->assertInstanceOf(ScheduleServiceRequest::class, $this->request);
    }
