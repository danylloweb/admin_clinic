...
class ScheduleHasCustomerRequestTest extends TestCase
{
    protected $request;
    ...
    {
        parent::setUp();
        $this->request = new ScheduleHasCustomerRequest;
    }

    public function test_request_can_be_instantiated(): void
    {
        $this->assertInstanceOf(ScheduleHasCustomerRequest::class, $this->request);
    }
