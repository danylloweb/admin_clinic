...
class OrderItemCreateRequestTest extends TestCase
{
    protected $request;
    ...
    {
        parent::setUp();
        $this->request = new OrderItemCreateRequest;
    }

    public function test_request_can_be_instantiated(): void
    {
        $this->assertInstanceOf(OrderItemCreateRequest::class, $this->request);
    }
