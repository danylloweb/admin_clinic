...
use Tests\TestCase;
use App\Http\Requests\ServiceAvailabilityLocationCreateRequest;
use Illuminate\Validation\Rule;

class ServiceAvailabilityLocationCreateRequestTest extends TestCase
{
    protected $request;
    ...
    {
        parent::setUp();
        $this->request = new ServiceAvailabilityLocationCreateRequest;
    }

    public function test_request_can_be_instantiated(): void
    {
        $this->assertInstanceOf(ServiceAvailabilityLocationCreateRequest::class, $this->request);
    }
