...
use Tests\TestCase;
use App\Http\Requests\ProfessionalScoresCreateRequest;
use Illuminate\Validation\Rule;

class ProfessionalScoresCreateRequestTest extends TestCase
{
    protected $request;
    ...
    {
        parent::setUp();
        $this->request = new ProfessionalScoresCreateRequest;
    }

    public function test_request_can_be_instantiated(): void
    {
        $this->assertInstanceOf(ProfessionalScoresCreateRequest::class, $this->request);
    }
